...
public class EMF_Creator {
    ...
    private static EntityManagerFactory createEntityManagerFactory(boolean isTest) {
        ...
        if (isDeployed) {
            ...
            String connection_str = System.getenv("CONNECTION_STR"); //Creates the full JDBC connection string
            //String connection_str = System.getenv("FULLCRUD_CONNECTION_STR") + dbName;
